...
class CalculateTotalPriceCategoryTest {
    CategoryModelMapper categoryModelMapper = new CategoryModelMapper();
    CalculateTotalPriceCategory calculate = new CalculateTotalPriceCategory();
    ...
    void testCanGetTotalPriceIfCategoryDoesntHaveSubscriptions() {
        ...
        double totalPrice = calculate.apply(userModel).get(category.getName());
